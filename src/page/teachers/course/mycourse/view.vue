        ...
        <el-row :gutter="10" v-for="(item, index) in computedData" :key="item.id">
          <el-col :span="12" class="workList-item">
            <div class="li">
              ...
              <div class="workdes">
                <router-link tag="span" to="/courseware?type=teacherTask">课件名称课件名称课件名称课件名称01<i></i></router-link>
                <var @click="handleOpenCourseware">开放课件 ></var>
                <router-link
                  to="/courseware?type=teacherTask"
                  tag="var"
          ...
          <el-col :span="12" class="workList-item">
            <div class="li">
              ...
              <div class="tasks">
                ...
                <div
                  :class="['tasksall',{'taskNo':!item.showText},{'icon':item.showText==='收取全部'}]"
                  @click="searchMore(item)"
                >
                  {{item.showText}}
                  <i v-show="item.showText">》</i>
                </div>
              </div>
            </div>
          </el-col>
...
.group-class /deep/ .el-dialog__header {
  padding: 0;
}

.group-class /deep/ .el-dialog__body {
  padding: 0;
}
</style>
