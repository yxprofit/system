    ...
    <aside :class="{'active':isNavShow}">
      ...
      <div>
        <a
          ...
          @click="toCurrent(1, '/student/course/mycourse')"
        ...
        <a
          :class="{'active':current==2,'over': over==2}"
          @click="toCurrent(2, '/student/course/mytest')"
          @mouseenter="addover(2)"
          @mouseleave="addover(0)"
        >
          <span>
            <img src="../../../assets/images/icon/icon_course_test_selected.png" v-if="current==2">
            <img src="../../../assets/images/icon/s2.png" v-else>
          </span>
          <span>我的测试</span>
        </a>
        <a
          :class="{'active':current==3,'over': over==3}"
          @click="toCurrent(3, '/student/course/works')"
          @mouseenter="addover(3)"
          @mouseleave="addover(0)"
        >
          <span>
            <img src="../../../assets/images/icon/icon_course_works_selected.png" v-if="current==3">
            <img src="../../../assets/images/icon/s3.png" v-else>
          </span>
          <span></span>
          <span>课程作品</span>
        </a>
