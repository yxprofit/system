    ...
    <div class="tendsHead">
      <section>
        ...
        <div class="teandsearch">
          <a class="upload" @click="changeUpload">
            <img :src="icon_task_close">上传作品
          </a>
        </div>
      </section>
      <div class="head">
        ...
        <div class="search-panel">
          <el-checkbox class="my-checkbox">我的作品</el-checkbox>
          <el-select
            class="search"
            v-model="classHoure"
            placeholder="课时"
              ...
              <div class="taskimg">
                ...
                <div class="but">
                  ...
                  <el-tooltip effect="dark" content="下载" placement="top">
                    <i @click="changedetails(item)">
                      <img :src="icon_39">
                    </i>
                  </el-tooltip>
                  <el-tooltip effect="dark" content="添加" placement="top">
                    <i>
                      <img class="add" :src="icon_42">
                    </i>
                  </el-tooltip>
                </div>
              </div>
